...
public class Line implements Embedding<Euclidean2D, Euclidean1D> , Hyperplane<Euclidean2D> {
    ...
    public Line(final Vector2D p1, final Vector2D p2) {
        ConstructorContext _bcornu_methode_context1 = new ConstructorContext(Line.class, 81, 3506, 3739);
        try {
            reset(p1, p2);
        } finally {
    ...
    public Line(final Vector2D p, final double angle) {
        ConstructorContext _bcornu_methode_context2 = new ConstructorContext(Line.class, 89, 3746, 3995);
        try {
            reset(p, angle);
        } finally {
    ...
    private Line(final double angle, final double cos, final double sin, final double originOffset) {
        ConstructorContext _bcornu_methode_context3 = new ConstructorContext(Line.class, 99, 4002, 4501);
        try {
            this.angle = angle;
    ...
    public Line(final Line line) {
        ConstructorContext _bcornu_methode_context4 = new ConstructorContext(Line.class, 111, 4508, 4928);
        try {
    ...
    public Line copySelf() {
        MethodContext _bcornu_methode_context1 = new MethodContext(Line.class, 119, 4935, 5020);
        try {
    ...
    public void reset(final Vector2D p1, final Vector2D p2) {
        MethodContext _bcornu_methode_context2 = new MethodContext(void.class, 128, 5027, 5836);
        try {
    ...
    public void reset(final Vector2D p, final double alpha) {
        MethodContext _bcornu_methode_context3 = new MethodContext(void.class, 149, 5843, 6313);
        try {
    ...
    public void revertSelf() {
        MethodContext _bcornu_methode_context4 = new MethodContext(void.class, 158, 6320, 6614);
        try {
    ...
    public Line getReverse() {
        MethodContext _bcornu_methode_context5 = new MethodContext(Line.class, 174, 6621, 7067);
        try {
    ...
    public Vector1D toSubSpace(final Vector<Euclidean2D> point) {
        MethodContext _bcornu_methode_context6 = new MethodContext(Vector1D.class, 180, 7074, 7269);
        try {
    ...
    public Vector2D toSpace(final Vector<Euclidean1D> point) {
        MethodContext _bcornu_methode_context7 = new MethodContext(Vector2D.class, 186, 7276, 7554);
        try {
            ...
            final double abscissa = CallChecker.varInit(((double) (CallChecker.isCalled(((Vector1D) (point)), Vector1D.class, 187, 7392, 7409).getX())), "abscissa", 187, 7368, 7417);
    ...
    public Vector2D intersection(final Line other) {
        MethodContext _bcornu_methode_context8 = new MethodContext(Vector2D.class, 197, 7561, 8153);
        try {
    ...
    public SubLine wholeHyperplane() {
        MethodContext _bcornu_methode_context9 = new MethodContext(SubLine.class, 207, 8160, 8278);
        try {
    ...
    public PolygonsSet wholeSpace() {
        MethodContext _bcornu_methode_context10 = new MethodContext(PolygonsSet.class, 215, 8285, 8521);
        try {
    ...
    public double getOffset(final Line line) {
        MethodContext _bcornu_methode_context11 = new MethodContext(double.class, 229, 8528, 9175);
        try {
    ...
    public double getOffset(final Vector<Euclidean2D> point) {
        MethodContext _bcornu_methode_context12 = new MethodContext(double.class, 235, 9182, 9375);
        try {
    ...
    public boolean sameOrientationAs(final Hyperplane<Euclidean2D> other) {
        MethodContext _bcornu_methode_context13 = new MethodContext(boolean.class, 241, 9382, 9586);
        try {
    ...
    public Vector2D getPointAt(final Vector1D abscissa, final double offset) {
        MethodContext _bcornu_methode_context14 = new MethodContext(Vector2D.class, 252, 9593, 10101);
        try {
    ...
    public boolean contains(final Vector2D p) {
        MethodContext _bcornu_methode_context15 = new MethodContext(boolean.class, 262, 10108, 10337);
        try {
    ...
    public double distance(final Vector2D p) {
        MethodContext _bcornu_methode_context16 = new MethodContext(double.class, 275, 10344, 10810);
        try {
    ...
    public boolean isParallelTo(final Line line) {
        MethodContext _bcornu_methode_context17 = new MethodContext(boolean.class, 284, 10817, 11173);
        try {
    ...
    public void translateToPoint(final Vector2D p) {
        MethodContext _bcornu_methode_context18 = new MethodContext(void.class, 291, 11180, 11408);
        try {
    ...
    public double getAngle() {
        MethodContext _bcornu_methode_context19 = new MethodContext(double.class, 298, 11415, 11621);
        try {
    ...
    public void setAngle(final double angle) {
        MethodContext _bcornu_methode_context20 = new MethodContext(void.class, 305, 11628, 11955);
        try {
    ...
    public double getOriginOffset() {
        MethodContext _bcornu_methode_context21 = new MethodContext(double.class, 314, 11962, 12115);
        try {
    ...
    public void setOriginOffset(final double offset) {
        MethodContext _bcornu_methode_context22 = new MethodContext(void.class, 321, 12122, 12296);
        try {
    ...
    public static Transform<Euclidean2D, Euclidean1D> getTransform(final AffineTransform transform) throws MathIllegalArgumentException {
        MethodContext _bcornu_methode_context23 = new MethodContext(Transform.class, 338, 12303, 13211);
        try {
    ...
    private static class LineTransform implements Transform<Euclidean2D, Euclidean1D> {
        ...
        public LineTransform(final AffineTransform transform) throws MathIllegalArgumentException {
            ConstructorContext _bcornu_methode_context5 = new ConstructorContext(Line.LineTransform.class, 371, 13968, 15014);
            try {
        ...
        public Vector2D apply(final Vector<Euclidean2D> point) {
            MethodContext _bcornu_methode_context24 = new MethodContext(Vector2D.class, 393, 15025, 15372);
            try {
        ...
        public Line apply(final Hyperplane<Euclidean2D> hyperplane) {
            MethodContext _bcornu_methode_context25 = new MethodContext(Line.class, 402, 15383, 16017);
            try {
        ...
        public SubHyperplane<Euclidean1D> apply(final SubHyperplane<Euclidean1D> sub, final Hyperplane<Euclidean2D> original, final Hyperplane<Euclidean2D> transformed) {
            MethodContext _bcornu_methode_context26 = new MethodContext(SubHyperplane.class, 414, 16028, 16727);
            try {
